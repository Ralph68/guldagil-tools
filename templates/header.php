<?php
/**
 * Titre: Header du portail Guldagil - Version modulaire complète
...
// Détection automatique du module actuel depuis l'URL si non défini
...
// Configuration CSS et JS modulaire - CORRIGÉ : true par défaut pour charger les assets
...
// Icône et couleur du module actuel
...
<head>
    ...
    <?php if ($module_css && $current_module !== 'home'): ?>
        <?php 
        // CSS depuis /public/nomdumodule/assets/css/nomdumodule.css
...
<body data-module="<?= $current_module ?>" data-module-status="<?= $module_status ?>">
    ...
    <!-- Module-specific JavaScript configurations -->
    <script>
        // Configuration globale module
        window.PortalConfig = {
