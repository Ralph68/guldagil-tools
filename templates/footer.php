                    ...
                    <div class="admin-grid">
                        ...
                        <div class="admin-card">
                            ...
                            <div class="card-actions">
                                ...
                                <a href="/dev/tools.php" class="admin-btn secondary">
                                    <span>🛠️</span>
                                    Outils
                                </a>
                            </div>
                ...
                <div class="footer-support">
                    ...
                    <div class="support-card">
                        <p class="support-text">
                            Notre équipe d'administration est là pour vous accompagner dans l'utilisation du portail.
                        </p>
                        <a href="#" class="contact-admin">
                            <span>💬</span>
            ...
            <div class="footer-container">
                <div class="footer-info">
                    <div class="version-section">
                        <h4 class="version-title">Informations système</h4>
                        <div class="version-details">
                            <div class="version-item">
                                <span class="version-label">Version</span>
                                <span class="version-value" data-type="version"><?= $app_version ?></span>
                            </div>
                            <div class="version-item">
                                <span class="version-label">Build</span>
                                <span class="version-value" data-type="build"><?= $build_number ?></span>
                            </div>
                            <div class="version-item">
                                <span class="version-label">Statut</span>
                                <span class="status-badge">✅ Opérationnel</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Copyright et statut -->
                <div class="copyright">
                    &copy; <?= date('Y') ?> <?= $app_author ?> - Tous droits réservés
                </div>
