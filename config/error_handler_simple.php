<?php
/**
 * Titre: Gestionnaire d'erreurs PHP simplifié anti-boucle
 * Chemin: /config/error_handler_simple.php
...
function simpleShutdownHandler() {
    ...
    if ($error && isFatalError($error['type'])) {
        ...
        // Affichage direct pour éviter les redirections infinies
        if (!headers_sent()) {
...
/**
 * Redirection sécurisée vers page d'erreur
 */
...
<body>
    <div class="error">
        ...
        <p>L\'équipe technique a été notifiée.</p>
